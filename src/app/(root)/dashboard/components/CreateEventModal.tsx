...
export default function CreateEventModal({ onClose }: CreateEventProps) {
   ...
   return (
      <ProtectedRoute>
         <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
            <Card className="overflow-y-auto w-full max-w-2xl max-h-[80vh] rounded-md p-5 font-inter ml-[25%] mr-[25%] mt-[5%] mb-[10%] w-fit justify-self-center">
               <CardContent>
